...
def load_data():
    ...
    #Turnout
    data['Turnout2012'] = (data['VotesDem2012'].add(data['VotesGOP2012'])).div(data['Population2012']-(data['Turnout2012'].div(100.0)).mul(data['Population2012']))
    data['Turnout2016'] = (data['VotesDem2016'].add(data['VotesGOP2016'])).div(data['Population2016']-(data['Turnout2016'].div(100.0)).mul(data['Population2016']))
    ...
    data['Youth2015'] = data['Youth2015'].div(100.0)
    ...
    data['Youth2009'] = data['Youth2009'].div(100.0)
    ...
    for county, record in zip(shpreader.Reader(fileName).geometries(), shpreader.Reader(fileName).records()):
        ...
        if fipsID in data.index:
            data['PopulationDensity2016'].loc[fipsID] = data['Population2016'].loc[fipsID]/(record.__dict__['attributes']['ALAND']/1000**2)
